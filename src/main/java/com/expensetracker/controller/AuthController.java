...
@Tag(
        name = "Authentication",
        description = "Endpoints for user identity management, including registration, secure login, and token maintenance."
)
public class AuthController {
    ...
    @Operation(
            ...
            description = "Creates a new user profile in the system with encrypted password storage."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Validates credentials and returns an Access JWT and a Refresh Token."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Exchanges a valid Refresh Token for a new short-lived Access JWT."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
